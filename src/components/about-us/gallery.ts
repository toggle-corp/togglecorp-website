...
const gallery: GalleryItem[] = [
    {
        ...
        image: celebration,
        imageAlt: 'life-at-TC',
        caption: 'When we have a "big win", we celebrate with cakes, donuts, and sometimes with chatpate or our favorite suntala/bhogate sadeko.',
    },
    {
        id: '2',
        image: yomari,
        imageAlt: 'life-at-TC',
        caption: 'Some are still hungry after eating a full thali for lunch, so they opt for more. Sometimes we wonder if we came here to work or to eat. Just Kidding!',
    },
    {
        id: '3',
        image: chatpateyParty,
        imageAlt: 'life-at-TC',
        caption: '"Guys, let\'s gather up at the kitchen. Hurry up, you don\'t want to miss it". Whenever any of us hears this, we can be sure we\'re going to have something good.',
    },
    {
        id: '4',
        image: samosa,
