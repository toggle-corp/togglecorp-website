...
const prinishaBaidya: Employee = {
    ...
    funnyDescription: 'Kasti hissii pareko',
    department: 'analysis',
...
const shristiManandhar: Employee = {
    ...
    position: 'Data Analyst',
    description: '',
    funnyDescription: 'I love watching Anime and Korean dramas. Also; Happily introverted :P. People say that I am hard worker and a team player :)',
    department: 'analysis',
