...
const amarShahi: Employee = {
  ...
  description:
    'My mom says she felt a small earthquake the day I was born, 26 years later it happened again on my birthday. That\'s my talent, earthquake is my thing. I also like airplanes which is why my favorite quote is "Startup world is like jumping off a cliff and assembling a plane on the way down."',
...
const subinaRajopadhyay: Employee = {
  ...
  description:
    "Front-end developer, Designer, Illustrator and aspiring Calligrapher by passion, Aspiring Data Scientist, Dog-lover, Potterhead, & a Massive Liverpool supporter #YNWA",
...
const shubhDhital: Employee = {
  ...
  description:
    "I go up to the mountains or I go find flaws in your work. Also, sometimes all you need to do is change that altitude.",
...
const safarLigal: Employee = {
  ...
  position: "Developer",
  description:
    "No man ever steps in th same river twice, for it's not the same river and he's not the same man.",
...
const nikaShakya: Employee = {
  ...
  description:
    "Hi, I am Nika Shakya. I received my bachelors degree in public health and currently i am working as junior data analyst. Talking about my personal interests i enjoy doing art stuffs, listening to music and love spending time in nature. Adding to that i love watching series in my free time.",
...
const prinishaBaidya: Employee = {
  ...
  description:
    "A fun loving girl who likes to be in a happy environment. Is an optimist, interested in music, sings and dances, keeps others happiness first, gets easily inspired. An altruist and a proud Leo member who enjoys helping others. Needs K-Pop and K-Drama doses at times.",
...
const rubyThapaliya: Employee = {
  ...
  description:
    "Myself Ruby from Western Nepal. I've always been outspoken, energetic and inquisitive to new things. I believe making someone laugh everyday makes my life worth living. I often give advice to people and have been keen to learn from their mistakes. As long as there's life, there's hope so everyone should keep striving to their desired purpose.",
...
const shreeyashShrestha: Employee = {
  ...
  position: "Developer",
  description:
    "Crafting code and building beautiful solutions with a passion for continuous learning and growth. Always striving to create and inspire change through technology.",
  funnyDescription:
    "Haule haule saajna; dheere dheere baalma. O ho ho hmm hmm hmm...",
  department: "development",
...
const ranjanShrestha: Employee = {
  ...
  description:
    "My interests change over time. It used to be Traveling and Photography but now it is driving. Wish for better road infrastructure so that I can drive over 100 kph.",
...
const babinKarmacharya: Employee = {
  ...
  position: "QA Engineer",
  description:
    "Breaking things professionally with a smile – I'm the QA Engineer who turns software glitches into comedy gold. Finding bugs is my superpower, fixing them is just a bonus",
  funnyDescription: "Malai Shreya le last bully hancha!",
  department: "development",
  instagramLink: "https://instagram.com/babin_karmacharya",
  linkedInLink:
    "https://www.linkedin.com/in/babin-kumar-karmacharya-b1789b220/",
};
...
const sudipKhanal: Employee = {
  ...
  instagramLink:
    "https://www.instagram.com/sudip057/profilecard/?igsh=MXMxNXljc2w3NXg0Yw==",
};
...
const ashmitaPaudel: Employee = {
  ...
  description:
    "Hi, I'm Ashmita, an explorer of ideas, places and good food. Behind my serious looking face, I'm always up for a good laugh, a stimulating brainstorming session, or a good travel story. If you find me staring into the nothingness, I'm either pondering the meaning of existence, or planning my next vacation.",
  department: "development",
...
const cyrusShrestha: Employee = {
  ...
  description:
    "Learning new things, making small wins, and enjoying the journey.",
  department: "development",
...
const safalShrestha: Employee = {
  ...
  position: "UI/UX Designer",
  description:
    "Designing clean and user-friendly experiences by day, gaming by night and occasionally judging the UI of both.",
  department: "development",
...
const amritBhusal: Employee = {
  ...
  position: "Frontend Developer",
  description:
    "Powered by chiya, curiosity, and clean code. Believes that every challenge has a solution.",
  department: "development",
